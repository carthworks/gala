...
<header class="main-header">
    ...
    <span class="logo-mini"><img src="<%=getTenantImage()%>" class="img-responsive " style="padding:3px;" alt="PCS Logo" /></span>
        ...
        <ul class="nav navbar-nav">
		  ...
		  <li class="dropdown user user-menu">
            <a href="#" class="ripplelink dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
              <img src="data:image/png;base64, <%=getUserImage()%>" class="user-image" alt="User Image1">  
              <span class="hidden-xs capitalize"><%=getUserName()%></span>
            </a>
            <ul class="dropdown-menu" style="box-shadow:1px 1px 8px #bbbaba;">
              <!-- User image -->
              <li class="user-header">
                 <img src="data:image/png;base64, <%=getUserImage()%>" class="img-circle" alt="User Image1">  
